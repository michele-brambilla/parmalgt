...
class latt{
  friend class SU2_fld;
  friend class Boson_fld;
  friend int get(SU2_fld*, int *);  
  friend int get(Boson_fld *, int *);
  ...
  friend class ptSU2_fld;
  friend class ptBoson_fld;
  ...
  friend ptSU2 staple(int n, int mu, int nu);
