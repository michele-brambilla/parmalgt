...
int initialize(int argc, char** argv){
  ...
  get_val(fp, "tau_f",       "%lf",&(act_pars.tau_f)  );
  ...
  strcpy(nspt_pars.damon,"w_damocle.dag");
  ...
  int opt;
  extern char *optarg;
  while ((opt = getopt(argc, argv, "l:s:b:d:r:g:f:a:t:p:c:n:h")) != -1) {
    switch (opt) {
    case 'l':
    ...
    case 'h':
      ...
      printf( "-g\t\ttau gluoni\n" );
      printf( "-f\t\ttau fermioni\n" );
      printf( "-a\t\talpha\n" );
      printf( "-t\t\tstato iniziale: 1)da configurazione; 0)freddo\n" );
  ...
  sprintf(nspt_pars.name2x2,"%s2x2_%s_nf0_%dx%dx%dx%d_a%2.2f_tg%3.3f_o%d.r%d.txt",
	  ...
	  act_pars.sz[2], act_pars.sz[3], fabs(act_pars.alpha), act_pars.tau_g, PTORD,rank);
#endif

  sprintf(nspt_pars.plaqn,"%s_%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.r%d.txt",
	  nspt_pars.plaqn, type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2], act_pars.sz[3], fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD,rank);

  sprintf(nspt_pars.confn,"%s%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.r%d.dat",
	  nspt_pars.confn, type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, allocORD,rank);

  sprintf(nspt_pars.logn,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.r%d.log",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD,rank);

  sprintf(nspt_pars.normn,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.r%d.nor",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD,rank);

  sprintf(nspt_pars.trun,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.r%d.trU",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD,rank);
  ...
  sprintf(nspt_pars.name2x2,"%s2x2_%s_nf0_%dx%dx%dx%d_a%2.2f_tg%3.3f_o%d.txt",
	  nspt_pars.plaqn, type_g, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2], act_pars.sz[3], fabs(act_pars.alpha), act_pars.tau_g, PTORD);
#endif

  sprintf(nspt_pars.plaqn,"%s_%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.txt",
	  nspt_pars.plaqn, type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2], act_pars.sz[3], fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);
#ifndef APE_CONFIG
  sprintf(nspt_pars.confn,"%s%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.dat",
	  nspt_pars.confn, type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, allocORD);
#endif
  sprintf(nspt_pars.logn,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.log",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);

  sprintf(nspt_pars.normn,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.nor",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);

  sprintf(nspt_pars.trun,"%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.trU",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);
...
char *kname = new char[100];
  ...
  sprintf(nspt_pars.normn,"knorm_%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.dat",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);
#else
  sprintf(nspt_pars.normn,"knorm_acc_%s_nf%d_%dx%dx%dx%d_a%2.2f_tg%3.3f_tf%3.3f_o%d.dat",
	  type_g, NF, act_pars.sz[0], act_pars.sz[1], 
	  act_pars.sz[2],act_pars.sz[3],fabs(act_pars.alpha), act_pars.tau_g, act_pars.tau_f, PTORD);
#endif
  FPkn = fopen(kname,"wb");
...
int UnquenchedAllocate(ptGluon_fld& Umu){
  ...
  if(!nspt_pars.Init){
    ...
    for (int i1=0; i1 <= PTORD; i1++){
      printf("%e\t%e\t%e\t%e\n",w[i1].re,w[i1].im,w1[i1].re,w1[i1].im);
    }
...
int AggiornaParametri(ptGluon_fld& Umu) {
  ...
  get_val(df, "tau_f",       "%lf",&(act_pars.tau_f)  );
  ...
  act_pars.stau = sqrt(act_pars.tau_g);
  //  ratio = (int)(act_pars.tau_f/act_pars.tau_g);

  logfile << "Tau_g\t\t\t"        << act_pars.tau_g << std::endl;
  logfile << "Tau_f\t\t\t"        << act_pars.tau_f << std::endl;
  logfile << std::endl;
  logfile.flush();
...
void NsptFinalize(ptGluon_fld& Umu, int t){
...
int main(int argc, char** argv){
  ...
  // Attenzione, contiene redefinizioni di tau_f,g
  if( UnquenchedAllocate(Umu) ) { exit(1); }
